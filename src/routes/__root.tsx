...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#99BC85" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "default" },
      { name: "apple-mobile-web-app-title", content: "REX" },
      ...
      { property: "og:description", content: "A shared little book of the restaurants, books, movies and shows your friends actually love." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://api.fontshare.com/v2/css?f[]=switzer@400,500,600,700&f[]=sentient@400,401,500,700&display=swap",
      },
    ],
  }),
