...
export const Route = createFileRoute("/_authenticated/group/$id")({
  head: () => ({
    meta: [
      { title: "Group — REX" },
      { name: "description", content: "A private group where you and your friends share Rex." },
      { property: "og:title", content: "Group — REX" },
      { property: "og:description", content: "A private group where you and your friends share Rex." },
